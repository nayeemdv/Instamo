...
import com.example.instamo.activities.AddCommentActivity
...
class PostAdapter
    ...
    private fun getComments(postId: String, comment: TextView) {
        ...
        commentRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(datasnapshot: DataSnapshot) {
                comment.text = "View all ${datasnapshot.childrenCount} comments"
            }
        })
    }
        ...
        postRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(datasnapshot: DataSnapshot) {
                if (datasnapshot.child(firebaseUser!!.uid).exists()) {
                    imageView.setImageResource(R.drawable.ic_heart_clicked)
                    postedImg.tag = " liked"
                    imageView.tag = "liked"
                } else {
                    imageView.setImageResource(R.drawable.ic_heart_not_clicked)
                    postedImg.tag = "like"
                    imageView.tag = "like"
                }
            }
    ...
    private fun getCountOfLikes(postId: String, likesNo: TextView) {
        ...
        postRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(datasnapshot: DataSnapshot) {
                likesNo.text = "${datasnapshot.childrenCount} likes"
            }
        })
    }
        ...
        savesRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.child(postId).exists()) {
                    imageView.setImageResource(R.drawable.ic_saved_post_filled)
                    imageView.tag = "Saved"
                } else {
